      ...
      tags$div(
        ...
        tags$nav(
          ...
          tags$div(
            ...
            actionButton("btn_logout", "Logout", icon = icon("sign-out-alt"), class = "btn btn-outline-danger btn-sm")
          )
        ),
        ...
        tags$div(
          ...
          tags$div(
            ...
            tags$div(
              ...
              tags$h1(class = "h2 text-gray-900 mb-3", "Klinik Dashboard"),
              tags$p(class = "mb-1", "Sistem analitik operasional, pasien, dokter, obat, dan keuangan."),
              tags$p(class = "text-muted", "Gunakan akun login untuk masuk ke dashboard multipage.")
            ),
            tags$div(
              class = "text-center",
              actionButton("go_login", "Login", class = "btn btn-primary btn-lg", icon = icon("sign-in-alt"))
            )
          )
        )
      )
...
login_ui <- function() {
  tags$div(
    ...
    tags$div(
      class = "row justify-content-center",
      tags$div(
        class = "col-xl-5 col-lg-6 col-md-8",
        tags$div(
          ...
          tags$div(
            ...
            tags$div(
              class = "p-5",
              tags$div(class = "text-center", tags$h1(class = "h4 text-gray-900 mb-4", "Login Dashboard")),
              textInput("username", "Username", placeholder = "Masukkan username"),
              passwordInput("password", "Password", placeholder = "Masukkan password"),
              actionButton("btn_login", "Masuk", class = "btn btn-primary btn-user btn-block"),
              tags$hr(),
              actionButton("back_landing", "Kembali ke Landing", class = "btn btn-light btn-user btn-block")
            )
          )
        )
      )
...
ui <- fluidPage(
  ...
  conditionalPanel("output.auth_stage === 'landing'", landing_ui()),
  conditionalPanel("output.auth_stage === 'login'", login_ui()),
  conditionalPanel("output.auth_stage === 'app'", sb_dashboard_body())
)
